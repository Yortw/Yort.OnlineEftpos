...
{
	/// <summary>
	/// Search criteria and options holder for <see cref="IOnlineEftposClient.RefundSearch(OnlineEftposRefundSearchOptions)"/>.
	/// </summary>
	public class OnlineEftposRefundSearchOptions
	{
		...
		/// <summary>
		/// The merchant's original order id (<see cref="RefundDetails.RefundId"/>) for the refund.
		/// </summary>
		public string RefundId { get; set; }
		/// <summary>
		/// The code that uniquley identifies the merchant who requested refund.
		/// </summary>
		...
		/// <summary>
		/// A Uri returned by a previous call to refund search, which is used to retrieve another page of results. Preferred over <see cref="Offset"/>.
		/// </summary>
		...
		public string BuildSearchQueryString()
		{
			...
			AppendKeyValuePairIfValueNotEmpty(sb, "refundId", RefundId);
